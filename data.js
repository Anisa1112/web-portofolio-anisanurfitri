...
const projectData = {
  ...
  data: {
    label: 'Data Analysis',
    projects: [
      { id: 'supermarket-sales-dashboard-power-bi', name: 'Supermarket Sales Dashboard (Power BI)', year: '2026', desc: 'This project presents an interactive sales dashboard built using Power BI to analyze supermarket transaction data. It provides insights into sales performance, customer behavior, product trends, and revenue distribution across different branches and categories.', stack: ['Data Visualization', 'Power BI', 'Data Analyst', 'Insight', 'Sales Perfomance'], github: 'https://github.com/Anisa1112/supermarket-sales-dashboard-powerbi.git', ppt: 'https://docs.google.com/presentation/d/1vF9Ysw_Sn-wLhe35mEaA72mi_ocnj78YXJgGmLNcoUQ/edit?usp=sharing' },
      { id: 'covid-19-indonesia-dashboard-tableau', name: 'COVID-19 Indonesia Dashboard (Tableau)', year: '2025', desc: 'This project presents an interactive COVID-19 dashboard for Indonesia built using Tableau. It visualizes key metrics such as total cases, deaths, recoveries, and health indicators (CFR and CRR) across time and regions.', stack: ['Tableau', 'Data Visualization', 'Insight', 'Data Analyst'], github: 'https://github.com/Anisa1112/COVID-19-Indonesia-Dashboard-Tableau.git', ppt: 'https://docs.google.com/presentation/d/1RHi85HZwSTWoZaPRtenbSy51iw7wB7RFjbcQAti-PPA/edit?usp=sharing' },
    ]
  },
  web: {
